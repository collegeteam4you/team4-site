...
const hairAdjustments = {
  male: {
    ...
    'hair-m-02': { width: '31%', top: '0.1%', x: '0%' },
    'hair-m-03': { width: '29%', top: '0.1%', x: '0%' },
    'hair-m-04': { width: '29%', top: '0.1%', x: '0%' },
    'hair-m-05': { width: '29%', top: '0.1%', x: '0%' },
    'hair-m-06': { width: '29%', top: '0.1%', x: '0%' },

    'hair-m-07': { width: '32%', top: '0.1%', x: '0%' },
    'hair-m-08': { width: '31%', top: '0.1%', x: '0%' },
    'hair-m-09': { width: '30%', top: '0.1%', x: '0%' },
    'hair-m-10': { width: '28%', top: '0.1%', x: '0%' },
    'hair-m-11': { width: '27%', top: '0.1%', x: '0%' },
    'hair-m-12': { width: '31%', top: '0.1%', x: '0%' },

    'hair-m-13': { width: '30%', top: '0.1%', x: '0%' },
    'hair-m-14': { width: '30%', top: '0.1%', x: '0%' },
    'hair-m-15': { width: '35%', top: '0.1%', x: '0%' },
    'hair-m-16': { width: '29%', top: '0.1%', x: '0%' },
    'hair-m-17': { width: '31%', top: '0.1%', x: '0%' },
