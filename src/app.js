...
let copy = {
  ...
  GEO: {
    ...
    heroText: 'თუ შენი გუნდი ბევრს მუშაობს, მაგრამ გაყიდვები მაინც არ იზრდება —პრობლემა პროდუქტში არა, კომუნიკაციაშია.დაჯავშნე უფასო კონსულტაცია და ნახე სად კარგავ გაყიდვებს',
